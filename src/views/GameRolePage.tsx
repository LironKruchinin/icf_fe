...
import { GameRoleData } from '../interface/GameRole';
...
const EventsPage = () => {
    ...
    const [events, setEvents] = useState<GameRoleData[]>([])
    const [originalEventData, setOriginalEventData] = useState<GameRoleData>({
        eventName: '',
        eventDescription: '',
        eventDate: 0,
    })
    const [eventData, setEventData] = useState<GameRoleData>({
        eventName: '',
        eventDescription: '',
        eventDate: 0,
        eventCloseDate: 0,
